...
<?php // Steaming pile of... ?>
  <!--[if lt IE 9]>
    <script src="<?php echo $res; ?>/third_party/js/html5shiv/html5shiv.min.js" type="javascript"></script>
    <script src="<?php echo $res; ?>/third_party/js/html5shiv/html5shiv-printshiv.min.js" type="javascript"></script>
  <![endif]-->
